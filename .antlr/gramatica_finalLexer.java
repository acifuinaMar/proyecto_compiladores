...
public class gramatica_finalLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "PROGRAM", "SI", "SINO", "WHILE", "FOR", "RETURN", "PRINT", "TIPO", 
			"LLAVEI", "LLAVED", "PAI", "PAD", "ASIG", "FINAL", "SUM", "RES", "MUL", 
			"DIV", "IGUAL", "NOIGUAL", "MENOR", "MAYOR", "MENORI", "MAYORI", "AND", 
			"OR", "NOT", "STRING", "NUM", "ID", "WS"
		};
	}
	...
	public gramatica_finalLexer(CharStream input) {
		super(input);
